...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    KEYMAP(
        ...
        RCTL,LALT, LGUI ,NO,      SPC,                     RGUI,FN0, RALT, LEFT, DOWN, RGHT),
    /* Keymap 1: FN Layer
     * ,----------------------------------------------------------.  ,---.
     ...
     */
    KEYMAP(
        PWR, F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12, F13, DEL, PGUP,\
        TRNS,TRNS,UP,  TRNS,TRNS,TRNS,CALC,TRNS,INS, TRNS,PSCR,SLCK,PAUS,CLEAR,      PGDN, \
        TRNS,LEFT,DOWN,RGHT,TRNS,TRNS,MSTP,MNXT,MPRV,MPLY,HOME,PGUP,     TRNS, \
        TRNS,NO,  TRNS,APP, TRNS, TRNS, TRNS, VOLD,VOLU,MUTE,END, PGDN,TRNS,NO,  TRNS, \
